<?PHP
  ...
  //Form validation NEEDS UPDATE
    ...
    } elseif(!$phone || !preg_match("/^\S+@\S+$/", $phone)) {
...
<body id="page-top">
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        ...
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">We rescue old computer hardware and restore it to new using Free and Open Source Software, custom tailored for your needs, with continuing support to keep you connected</p>
  ...
  <section class="page-section bg-dark text-white" id="comparison">
...
-->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <hr class="divider my-4">
          <p class="text-muted mb-5">Ready to get the most out of your computer for an unbeatable price? Give us a call or send us an email (or fill out and submit the form below), and we will schedule a free appraisal at your convenience!</p>
        </div>
      </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="online_name" value="<?PHP if(isset($_POST['online_name'])) echo htmlspecialchars($_POST['online_name']); ?>" placeholder="Name">
    </div>
  </div>
  <div class="form-group row">
    <label for="phone_number" class="col-sm-2 col-form-label">Phone Number</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="phone_number" value="<?PHP if(isset($_POST['phone_number'])) echo htmlspecialchars($_POST['phone_number']); ?>" placeholder="Phone">
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="computer_status" id="gridRadios1" value="has_comp" checked>
          <label class="form-check-label" for="gridRadios1">
            Rescue my old computer!
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="computer_status" id="gridRadios2" value="needs_comp">
          <label class="form-check-label" for="gridRadios2">
            I need a new (rescued) computer!
          </label>
        </div>
      </div>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <textarea class="form-control" rows="3" name="comments"><?PHP if(isset($_POST['comments'])) echo htmlspecialchars($_POST['comments']); ?></textarea>
    </div>
  </div> 
  <div class="row justify-content-center">
